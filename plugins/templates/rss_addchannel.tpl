...
$(document).ready(function(){
	...
	showhideBlocks();
						...
						var vl = $('#news_date').val();
								   ...
								   $('#r'+ vl ).css( "display", "inline" );
								   $('#i'+ vl ).css( "display", "inline" );

                        }
    </script>
	
<style type="text/css">
 #i1,#i0,#r1,#r0{display:none}  
select.load_img {
width:150px;
}
ul.tabs {
...
<div class="section">
  ...
  <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   ...
   <td style="padding:4px"><input type="text"  size="5" name="add_pause" value="{add-pause}"> {sek}
      ...
      <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px" width="260"><b>{most_url}:</b></td>
 <td style="padding:4px"><input class="load_img" size="70" type="url" name="most_url" value="{most-url}">
  <a href="#" class="hintanchor" onMouseover="showhint('{help_most_url}', this, event, '420px')">[?]</a>
   </td>
  </tr>
...
<input type="checkbox" name="allow_mod" value="1"    {allow-mod} />
 ...
 <input type="checkbox" name="auto" value="1" {allow-auto} />
  ...
  <td style="padding:4px">
   <select name="news_date" class="load_img" id="news_date" onchange="showhideBlocks(this.value)">
    {date-format}
   </select>
   <a href="#" class="hintanchor" onMouseover="showhint('{help_date_news}', this, event, '360px')">[?]</a>
    ...
    <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
  <td style="padding:4px" width="260">
   <div id="i0">{date_news_plus}:</div>
   <div id="i1">{date_news_ran}:</div>
  
  </td>
  <td style="padding:4px">
                <div id="r0"><input type="text"  size="5" name="news_date_plus" value="{news-date-plus}"></div>
                <div id="r1"> {s_news}  <input type="text" data-rel="calendar" size="20" name="news_date_ran_s" value="{news-date-ran-s}"> {po_news} <input type="text"  data-rel="calendar"  size="20" name="news_date_ran_to" value="{news-date-ran-to}"></div>
...
<a href="#" class="hintanchor" onMouseover="showhint('{help_max_image}', this, event, '220px')">[?]</a>
    ...
    <tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px"  width="260">{rz_img} <a href="#" class="hintanchor" onMouseover="showhint('{help_rz_img}', this, event, '220px')">[?]</a> :</td>
   <td style="padding:4px">
{rz_left}&nbsp;<input type="text" size="5" name="rz_rl" value="{rz-rl}">&nbsp;
{rz_right}&nbsp;<input type="text" size="5" name="rz_rr" value="{rz-rr}">&nbsp;
{rz_top}&nbsp;<input type="text" size="5" name="rz_rt" value="{rz-rt}">&nbsp;
{rz_bottom}&nbsp;<input type="text" size="5" name="rz_rb" value="{rz-rb}">
	</td>
  </tr>
...
<tr style="border-bottom:1px dashed #c4c4c4; border-top:1px dashed #c4c4c4">
   <td style="padding:4px"  width="304">{shortstory_add}</td>
   <td width="768" style="padding:4px">
<input type="checkbox" name="add_short" value="1" {add-short}/>
   <a href="#" class="hintanchor" onMouseover="showhint('{help_shortstory_add}', this, event, '420px')">[?]</a>
  </td>
  </tr>
...
<input type="hidden" name="kol_xfields" id="kol_xfields" value="{kol-xfields}" />
{xfields-template}
