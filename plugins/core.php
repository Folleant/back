...
}elseif ($config['version_id'] <'11.4'){
echo '<script data-cfasync="false" type="text/javascript" src="engine/classes/js/dle_js.js"></script>
<script data-cfasync="false" type="text/javascript" src="engine/skins/grabber/js/dle_ajax.js"></script>
<link rel="stylesheet" href="engine/skins/grabber/css/jquery-ui.css" />
<script data-cfasync="false" type="text/javascript" src="engine/skins/grabber/js/jquery.js"></script>';
}else{
echo '
<link rel="stylesheet" href="engine/skins/grabber/css/jquery-ui.css" />';
}
...
echo '<link rel="stylesheet" type="text/css" href="engine/skins/grabber/css/default.css?230711">
	  <style type="text/css">
.bd0 {width: 2%;}
@media screen and (-webkit-min-device-pixel-ratio:0){.bd0 {width: 2px;}.bd0:not(:root:root){width: 2%;}}
</style>
