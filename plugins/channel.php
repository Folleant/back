...
if (!class_exists('DLEPlugins')) {abstract class DLEPlugins {public static function Check($source) {return $source;}} }
...
require_once (DLEPlugins::Check(ENGINE_DIR.'/classes/rss.class.php'));
