...
if (!class_exists('DLEPlugins')) {class DLEPlugins {public static function Check($source) {return $source;}} }

include_once ENGINE_DIR .'/inc/plugins/backup.php';
include_once (DLEPlugins::Check(ENGINE_DIR .'/inc/plugins/rss.classes.php'));
