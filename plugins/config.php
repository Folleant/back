...
/////////////////////
echo "<tbody style=\"background: #FFF9E0; color:red\" id= \"radikal\">";
tablehead ('<font color="red">radikal.ru</font>');
...
/////////////////////
echo "<tbody style=\"background: #FFF9E0; color:red\" id= \"fastpic\">";
tablehead ('<font color="red">fastpic</font>');

tablehead ($lang_grabber['post_max_size'].' 10 Mb');
/////////////////////

/////////////////////
echo "<tbody style=\"background: #FFF9E0; color:red\" id= \"imgaws\">";
tablehead ('<font color="red">imgaws</font>');
showRow( 'Login','',"<input class=edit type=text style=\"text-align: center;\" name='conf_log[imgaws_log]' value=\"{$config_rss['imgaws_log']}\" size=50>" );
showRow( 'Password', '',"<input class=edit type=text style=\"text-align: center;\" name='conf_log[imgaws_pass]' value=\"{$config_rss['imgaws_pass']}\" size=50>" );
showRow( 'Adult','', makeDropDown( array ("0"=>$lang['opt_sys_no'],"1"=>$lang['opt_sys_yes'] ),"conf_log[imgaws_adult]",$config_rss['imgaws_adult'] ));
showRow( 'Preview','', makeDropDown( array ("1"=>$lang['opt_sys_no'],"0"=>$lang['opt_sys_yes'] ),"conf_log[url_imgaws]",$config_rss['url_imgaws'] ));
...
showRow( $lang_grabber['img_cash'],$lang_grabber['help_img_cash'],makeDropDown( array ("no"=>$lang['opt_sys_no'],"yes"=>$lang['opt_sys_yes']),"conf_log[img_cash]",$config_rss['img_cash'] ) );
echo "<tr>
...
showRow( $lang_grabber['medium_thumb'], $lang_grabber['help_medium_thumb'],makeDropDown( array ("0"=>$lang['opt_sys_no'],"1"=>$lang['opt_sys_yes'] ),"conf_log[medium_thumb]",$config_rss['medium_thumb'] ) );
...
showRow( $lang_grabber['xfield_stop'], $lang_grabber['help_xfield_stop'],makeDropDown( array ("0"=>$lang['opt_sys_yes'],"1"=>$lang['opt_sys_no'] ),"conf_log[xfield_stop]",$config_rss['xfield_stop'] ) );
...
showRow( $lang_grabber['parentid'], $lang_grabber['help_parentid'],makeDropDown( array ("0"=>$lang['opt_sys_no'],"1"=>$lang['opt_sys_yes'] ),"conf_log[parentid]",$config_rss['parentid'] ) );
...
showRow($lang_grabber['all_canal'],$lang_grabber['help_all_canal'],"<input class=edit type=text style=\"text-align: center;\" name='conf_log[all_canal]' value=\"{$config_rss['all_canal']}\" size=10>");
...
showRow('Логин Вконтакте',"","<input class=edit type=text style=\"text-align: center;\" name='conf_log[vk_login]' value=\"{$config_rss['vk_login']}\" size=30>");
showRow('Пароль Вконтакте',"","<input class=edit type=text style=\"text-align: center;\" name='conf_log[vk_password]' value=\"{$config_rss['vk_password']}\" size=30>");
showRow('ID сообщества',"","<input class=edit type=text style=\"text-align: center;\" name='conf_log[gorup_id]' value=\"{$config_rss['gorup_id']}\" size=30>");
showRow('Альбом для загрузки',"","<input class=edit type=text style=\"text-align: center;\" name='conf_log[album_id]' value=\"{$config_rss['album_id']}\" size=30>");
}	
